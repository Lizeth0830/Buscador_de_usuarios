...
export default function App() {
  ...
  // ⚡ Aquí apuntas al backend en el puerto 5000
      ...
      setTimeout(() => {
        ...
        const resultados = usuarios.filter((usuario) =>
          [
            ...
            campo ? String(campo).toLowerCase().includes(q) : false
          )
        )
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      ...
      <h1 className="text-2xl font-bold mb-4 text-center">Buscador interactivo</h1>
